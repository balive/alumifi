...
(function () {
    ...
    var tab$2 = function (editor) {
      ...
      var maybeUrlize = function (editor, key) {
        return find(urls, function (x) {
          ...
          return makeLink({
            name: x.name,
            url: 'https://www.tiny.cloud/documentation/plugins/' + urlSlug
          });
        });
      };
    ...
    var tab$3 = function () {
      ...
      var changeLogLink = '<a href="https://www.tinymce.com/documentation/changelog/?utm_campaign=editor_referral&utm_medium=help_dialog&utm_source=tinymce" target="_blank">TinyMCE ' + version + '</a>';
      var htmlPanel = {
        type: 'htmlpanel',
