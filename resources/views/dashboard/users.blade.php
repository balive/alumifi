                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="label label-lg label-primary label-inline mb-1"> {{ $row['type'] }} </span>
                                </td>
                            ...
                            <div class="card-body">
                                ...
                                <div  class="row form-group">
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <input required type="text" class="form-control form-control form-control-solid " name="email" value="{{ $row['email'] }}">
                                    </div>
