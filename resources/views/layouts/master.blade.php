...
<div id="bodyContainer" style="overflow-y: auto; @if(!isset(auth()->user()->type) || (isset(auth()->user()->type) && auth()->user()->type == 'client') && (request()->segment(2) == null || request()->segment(2) == 'conversations') ) height: 83% @else;height: 100%; @endif">
    ...
    <div id="kt_header_mobile" class="header-mobile">
        <!--begin::Logo-->
        <a href="{{ URL::to('/') }}">
            <img alt="Logo" src="{{ asset('alumifi-logo2.png') }}" class="logo-default max-h-30px" />
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
