                    ...
                    <!--begin: Wizard Step 1-->
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="pb-10 pb-lg-15">
                                ...
                                <div class="text-white font-weight-bold font-size-h4"> Already have an Account ?
                                    <a style="color: #f4da3e"  href=" <?php echo e(route('login')); ?>" class=" font-weight-bolder"> Sign In </a></div>
                            </div>
                            <!--begin::Title-->
                            <!--begin::Form Group-->
                            ...
                            <div class="form-group firstcont">
                                <label class="font-size-h6 font-weight-bolder text-white">  Name  <span style="color: red">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-white"> Email Address <span style="color: red">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-white">Password <span style="color: red">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-white">Confirm Password <span style="color: red">*</span></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            ...
                            <div>
                                <button style="background-color:#f4da3e"  class="btn  font-weight-bolder font-size-h6 pl-5 pr-8 py-4 my-3" data-wizard-type="action-submit" type="submit" id="kt_login_signup_form_submit_button"> Sign Up
...
<!--end::Body-->
</html><?php /**PATH D:\Laravel pros\gptBot\resources\views/auth/register.blade.php ENDPATH**/ ?>