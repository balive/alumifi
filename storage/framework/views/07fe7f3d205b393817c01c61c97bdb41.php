                ...
                <div class="card-body py-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                <td >
                                    <span class="text-muted text-capitalize font-weight-bold"><?php echo e($row['name']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted text-capitalize font-weight-bold"><?php echo e($row['description']); ?>  </span>
                                </td>

                                <td >
                                    <span style="white-space:pre-wrap" class="text-muted text-capitalize font-weight-bold"><?php echo e($row['features']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted text-capitalize font-weight-bold">$<?php echo e($row['type'] === "yearly" ? $row['price_yearly'] : $row['price_monthly']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted text-capitalize font-weight-bold"><?php echo e($row['access_no']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted text-capitalize font-weight-bold"><?php echo e($row['trial_days']); ?>  </span>
                                </td>
                                ...
                                <td >
                                    <span class="label label-lg <?php if($row->status): ?> label-light-primary <?php else: ?> label-light-warning <?php endif; ?> label-inline"> <?php if($row['status']): ?> <?php echo e('active'); ?> <?php else: ?> <?php echo e('unactive'); ?> <?php endif; ?></span>
                                </td>

                                <td>
                                    <span class="text-muted text-capitalize font-weight-bold"><?php echo e($row['created_at']); ?>  </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="<?php echo e(route('plan.delete' , $row->id)); ?>" data-id="<?php echo e($row->id); ?>" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="<?php echo e(route('plan.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="card-body">
                        ...
                        <form class="form" method="POST" action="<?php echo e(route('plan.store')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div  class="row form-group">
                                    ...
                                    <input style="text-transform: capitalize" hidden type="text" class="form-control form-control form-control-solid " name="id" value="<?php echo e($row['id']); ?>">


                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label"> Name</label>
                                        <input required style="text-transform: capitalize"  type="text" class="form-control form-control form-control-solid " name="name" value="<?php echo e($row['name']); ?>">
                                    </div>

                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">Description</label>
                                        <input required   type="text" class="form-control form-control form-control-solid " name="description" value="<?php echo e($row['description']); ?>">
                                    </div>

                                    <div class="col-12 col-md-12">
                                        <br>
                                        <label  class=" form-control-label">Features</label>
                                        <textarea required   type="text" class="form-control form-control form-control-solid " name="features"><?php echo $row['features']; ?></textarea>
                                    </div>

                                    <div  class="col-12 col-md-12 ">
                                        <br>
                                        <label class=" form-control-label"> Prompts  <b>(0 = unlimited )</b></label>
                                        <input  style="text-transform: capitalize"  type="number" class="form-control form-control form-control-solid " name="access_no" value="<?php echo e($row['access_no']); ?>">
                                    </div>

                                    <div class="col-12 col-md-12 ">
                                        <br>
                                        <label  class=" form-control-label"> Price Monthly</label>
                                        <input  style="text-transform: capitalize"  type="text" class="form-control form-control form-control-solid " name="price_monthly" value="<?php echo e($row['price_monthly']); ?>">
                                    </div>

                                    <div class="col-12 col-md-12 ">
                                        <br>
                                        <label  class=" form-control-label"> Price Yearly</label>
                                        <input  style="text-transform: capitalize"  type="text" class="form-control form-control form-control-solid " name="price_yearly" value="<?php echo e($row['price_yearly']); ?>">
                                    </div>

                                    <div class="col-12 col-md-12 ">
                                        <br>
                                        <label  class=" form-control-label"> Stripe Price Id Monthly</label>
                                        <input  style="text-transform: capitalize"  type="text" class="form-control form-control form-control-solid " name="stripe_price_monthly_id" value="<?php echo e($row['stripe_price_monthly_id']); ?>">
                                    </div>

                                    <div class="col-12 col-md-12 ">
                                        <br>
                                        <label  class=" form-control-label"> Stripe Price Id Yearly</label>
                                        <input  style="text-transform: capitalize"  type="text" class="form-control form-control form-control-solid " name="stripe_price_yearly_id" value="<?php echo e($row['stripe_price_yearly_id']); ?>">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <select  name="type"  class="form-control form-control-lg form-control-solid " required>
                                            <option disabled selected value="" class="form-control-lg form-control-solid ">Please select</option>
                                            <option <?php if($row['type'] == 'free'): ?> selected <?php endif; ?>  value="free" class="form-control-lg form-control-solid" >Free</option>
                                            <option <?php if($row['type'] == 'monthly'): ?> selected <?php endif; ?>  value="monthly" class="form-control-lg form-control-solid" >Monthly</option>
                                            <option <?php if($row['type'] == 'yearly'): ?> selected <?php endif; ?>  value="yearly" class="form-control-lg form-control-solid"  >Yearly</option>
                                    ...
                                    <div  class="col-12 col-md-12 ">
                                        <br>
                                        <label  class=" form-control-label"> Trial Days </label>
                                        <input  style="text-transform: capitalize"  type="number" class="form-control form-control form-control-solid " name="trial_days" value="<?php echo e($row['trial_days']); ?>">
                                    </div>
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <select name="status"  class="form-control form-control-lg form-control-solid " required>
                                            <option disabled selected value="" class="form-control-lg form-control-solid ">Please select</option>
                                            <option <?php if($row['status'] == 1): ?> selected <?php endif; ?>  value="1" class="form-control-lg form-control-solid" >Active</option>
                                            <option <?php if($row['status'] == 0): ?> selected <?php endif; ?>  value="0" class="form-control-lg form-control-solid" >Unactive</option>
                                        </select>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\gptBot\resources\views/dashboard/plans.blade.php ENDPATH**/ ?>