        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                ...
                <div class="d-block align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <?php if(!isset(auth()->user()->type) || (isset(auth()->user()->type) && auth()->user()->type == 'client')): ?>
                        <img style="width: 125px" class="mb-5 header-logo" src="<?php echo e(asset('alumifi-logo2.png')); ?>">
                    <?php else: ?>
                    ...
                    <div class="recheck_section  <?php if(isset(auth()->user()->type) && auth()->user()->type == "client" && isset($conversation) && $conversation->id): ?> <?php else: ?> d-none <?php endif; ?>">
                                                ...
                                                <?php $__currentLoopData = $conversation->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conversation_message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="gpt-entry">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div id="message_<?php echo e($loop->index); ?>" style="color:white; background: transparent;" class="rounded pl-4 pt-1 font-weight-bold font-size-lg text-left max-w-600px">
                                                                <?php echo $conversation_message['answer']; ?>


                                                                <button class="copy-btn" data-target="message_<?php echo e($loop->index); ?>" style="position: absolute; left: 30px; background-color: transparent; color: white; border: none; border-radius: 0%; padding: 0px; cursor: pointer;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\biasBot\resources\views/dashboard/index.blade.php ENDPATH**/ ?>