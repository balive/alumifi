        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h2 style="color: #3a384e"  class="d-flex align-items-center font-weight-bolder my-1 mr-3">Users</h2>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="label label-lg label-primary label-inline mb-1"> <?php echo e($row['type']); ?> </span>
                                </td>
                            ...
                            <div class="card-body">
                                ...
                                <div  class="row form-group">
                                    ...
                                    <div class="col-12 col-md-12">
                                        ...
                                        <input required type="text" class="form-control form-control form-control-solid " name="email" value="<?php echo e($row['email']); ?>">
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\biasBot\resources\views/dashboard/users.blade.php ENDPATH**/ ?>