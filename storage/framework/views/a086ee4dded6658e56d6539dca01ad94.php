                ...
                <div class="login-form">
                    ...
                    <div class="pb-10 pb-lg-15">
                        ...
                        <div class="text-muted font-weight-bold font-size-h4"> Don't have an Account ?
                            <a style="color: #f4da3e" href=" <?php echo e(route('register')); ?>" class=" font-weight-bolder"> Sign Up </a></div>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-between mt-n5">
                                ...
                                <a style="color: #f4da3e" href="<?php echo e(route('password.request')); ?>" class=" font-size-h6 font-weight-bolder text-hover-primary pt-5">Forgot your password ?</a>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="pb-lg-0 pb-5">
                            ...
                            <button style="background: #f4da3e" type="submit" id="kt_login_singin_form_submit_button" class="btn  font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">
                                Sign In
                            </button>
                        </div>
...
<!--end::Body-->
</html><?php /**PATH D:\Laravel pros\gptBot\resources\views/auth/login.blade.php ENDPATH**/ ?>