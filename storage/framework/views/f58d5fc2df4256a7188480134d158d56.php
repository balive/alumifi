...
<div id="bodyContainer" style="overflow-y: auto; <?php if(!isset(auth()->user()->type) || (isset(auth()->user()->type) && auth()->user()->type == 'client') && (request()->segment(2) == null || request()->segment(2) == 'conversations') ): ?> height: 83% <?php else: ?>;height: 100%; <?php endif; ?>">
...
<?php /**PATH D:\Laravel pros\biasBot\resources\views/layouts/master.blade.php ENDPATH**/ ?>